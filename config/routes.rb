...
#                                                    root GET        /                                                                                           music#index
#                                                    home GET        /home(.:format)                                                                             music#index
#                                                  albums GET        /albums(.:format)                                                                           music#index
#                                                         GET        /albums/:id(.:format)                                                                       music#index
#                                                 artists GET        /artists(.:format)                                                                          music#index
#                                                         GET        /artists/:id(.:format)                                                                      music#index
#                                                         GET        /artist/:id(.:format)                                                                       music#index
#                                                         GET        /profile/:id(.:format)                                                                      music#index
...
#                           surprise_me_api_v1_play_lists GET        /api/v1/play_lists/surprise_me(.:format)                                                    api/v1/play_lists#surprise_me
...
#               autocomplete_song_name_backend_play_lists GET        /backend/play_lists/autocomplete_song_name(.:format)                                        backend/play_lists#autocomplete_song_name
